...
-- Indexes
CREATE INDEX "animal_farm_idx" ON "animal" USING btree ("farmId");

--
-- Class AnimalObservation as table animal_observation
--
CREATE TABLE "animal_observation" (
    ...
    "appetiteScore" bigint,
    "feedIntake" double precision,
    "productionValue" double precision,
    "productionUnit" text,
    "visibleSymptoms" text,
    "notes" text,
    "recordedBy" text NOT NULL
);

-- Indexes
CREATE INDEX "observation_animal_recorded_idx" ON "animal_observation" USING btree ("animalId", "recordedAt");

--
-- Class Farm as table farm
--
CREATE TABLE "farm" (
    "id" bigserial PRIMARY KEY,
...
-- Indexes
CREATE INDEX "farm_owner_idx" ON "farm" USING btree ("ownerId");

--
-- Class FarmAlert as table farm_alert
--
CREATE TABLE "farm_alert" (
    "id" bigserial PRIMARY KEY,
    "farmId" bigint NOT NULL,
    "animalId" bigint,
...
-- Indexes
CREATE INDEX "alert_farm_active_idx" ON "farm_alert" USING btree ("farmId", "resolvedAt");

--
-- Class FarmTask as table farm_task
--
...
-- Indexes
CREATE INDEX "task_farm_status_idx" ON "farm_task" USING btree ("farmId", "status");

--
-- Class FeedRecord as table feed_record
--
...
-- Indexes
CREATE INDEX "feed_farm_recorded_idx" ON "feed_record" USING btree ("farmId", "recordedAt");

--
-- Class HealthRecord as table health_record
--
...
-- Indexes
CREATE INDEX "health_animal_recorded_idx" ON "health_record" USING btree ("animalId", "recordedAt");

--
-- Class ProductionRecord as table production_record
--
...
-- Indexes
CREATE INDEX "production_animal_recorded_idx" ON "production_record" USING btree ("animalId", "recordedAt");

--
-- Class SentinelAssessment as table sentinel_assessment
--
CREATE TABLE "sentinel_assessment" (
    "id" bigserial PRIMARY KEY,
    "farmId" bigint NOT NULL,
    "animalId" bigint NOT NULL,
...
-- Indexes
CREATE INDEX "assessment_animal_assessed_idx" ON "sentinel_assessment" USING btree ("animalId", "assessedAt");

--
-- Class VaccinationRecord as table vaccination_record
--
CREATE TABLE "vaccination_record" (
    "id" bigserial PRIMARY KEY,
    "animalId" bigint NOT NULL,
    "vaccination" text NOT NULL,
    "administeredAt" timestamp without time zone NOT NULL,
...
-- Indexes
CREATE INDEX "vaccination_animal_idx" ON "vaccination_record" USING btree ("animalId");
...
--
-- Foreign relations for "animal" table
--
ALTER TABLE ONLY "animal"
    ADD CONSTRAINT "animal_fk_0"
    FOREIGN KEY("farmId")
    REFERENCES "farm"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "animal_observation" table
--
ALTER TABLE ONLY "animal_observation"
    ADD CONSTRAINT "animal_observation_fk_0"
...
--
-- Foreign relations for "farm_alert" table
--
ALTER TABLE ONLY "farm_alert"
    ADD CONSTRAINT "farm_alert_fk_0"
    FOREIGN KEY("farmId")
    REFERENCES "farm"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "farm_alert"
    ADD CONSTRAINT "farm_alert_fk_1"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "farm_task" table
--
ALTER TABLE ONLY "farm_task"
    ADD CONSTRAINT "farm_task_fk_0"
    FOREIGN KEY("farmId")
    REFERENCES "farm"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "farm_task"
    ADD CONSTRAINT "farm_task_fk_1"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "feed_record" table
--
ALTER TABLE ONLY "feed_record"
    ADD CONSTRAINT "feed_record_fk_0"
    FOREIGN KEY("farmId")
    REFERENCES "farm"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "feed_record"
    ADD CONSTRAINT "feed_record_fk_1"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "health_record" table
--
ALTER TABLE ONLY "health_record"
    ADD CONSTRAINT "health_record_fk_0"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "production_record" table
--
ALTER TABLE ONLY "production_record"
    ADD CONSTRAINT "production_record_fk_0"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "sentinel_assessment" table
--
ALTER TABLE ONLY "sentinel_assessment"
    ADD CONSTRAINT "sentinel_assessment_fk_0"
    FOREIGN KEY("farmId")
    REFERENCES "farm"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "sentinel_assessment"
    ADD CONSTRAINT "sentinel_assessment_fk_1"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "sentinel_assessment"
    ADD CONSTRAINT "sentinel_assessment_fk_2"
    FOREIGN KEY("sourceObservationId")
    REFERENCES "animal_observation"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;

--
-- Foreign relations for "vaccination_record" table
--
ALTER TABLE ONLY "vaccination_record"
    ADD CONSTRAINT "vaccination_record_fk_0"
    FOREIGN KEY("animalId")
    REFERENCES "animal"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
...
--
-- MIGRATION VERSION FOR mavuno
--
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('mavuno', '20260919112408519', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260919112408519', "timestamp" = now();
